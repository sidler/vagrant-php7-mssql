  ...
  # documentation for more information about their specific syntax and use.
   config.vm.provision "shell", inline: <<-SHELL
    ...
    echo "basic packages setup"
		 ...
		 yum update -y
		 yum install -y php php-pdo php-xml php-pear php-devel re2c gcc-c++ gcc php-sqlsrv httpd php-xdebug php-gd php-mbstring php-xml mod_ssl vim kernel kernel-devel
